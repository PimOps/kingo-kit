...
Ollama and its Claude Code launcher are host-native Ubuntu Linux additions, not Compose services. They are omitted from the macOS and Windows/WSL installers.
